...
CREATE TABLE IF NOT EXISTS `levya_identity`.`COUNTRY` (
  ...
  `COUNTRY_FIPS104` VARCHAR(2) NOT NULL,
  `COUNTRY_ISO2` VARCHAR(2) NOT NULL,
  `COUNTRY_ISO3` VARCHAR(3) NOT NULL,
  `COUNTRY_ISON` VARCHAR(4) NOT NULL,
  `COUNTRY_INTERNET` VARCHAR(2) NOT NULL,
  `COUNTRY_CAPITAL` VARCHAR(25) NULL,
  `COUNTRY_MAPREFERENCE` VARCHAR(50) NULL DEFAULT NULL,
  `COUNTRY_NATIONALITYSINGULAR` VARCHAR(35) NULL DEFAULT NULL,
  `COUNTRY_NATIONALITYPLURAL` VARCHAR(35) NULL DEFAULT NULL,
  `COUNTRY_CURRENCY` VARCHAR(30) NULL DEFAULT NULL,
  `COUNTRY_CURRENCYCODE` VARCHAR(3) NULL DEFAULT NULL,
  `COUNTRY_POPULATION` BIGINT(20) NULL DEFAULT NULL,
  `COUNTRY_TITLE` VARCHAR(50) NULL DEFAULT NULL,
  `COUNTRY_COMMENT` VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `levya_identity`.`USER` (
  ...
  `COUNTRY_CountryId` SMALLINT(6) NULL,
  ...
  INDEX `fk_USER_COUNTRIE1_idx` (`COUNTRY_CountryId` ASC),
